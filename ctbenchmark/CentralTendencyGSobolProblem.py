...
class CentralTendencyGSobolProblem(CentralTendencyBenchmarkProblem):
    def __init__(self, a=[1., 2., 3., 4., 5.]):
        """
        ...
        distributionList = [ot.TruncatedDistribution(ot.Normal(0.5, 0.15), 0., 1.) for i in range(dimension)]
        ...
        mean = 0.4334546783396362
        std = 0.13995929792908476

        super(CentralTendencyGSobolProblem, self).__init__(name, compositeRandomVector, 
                                                        mean, std)
        return None
